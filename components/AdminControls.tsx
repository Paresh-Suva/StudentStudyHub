...
import { MoreVertical, Trash2, Pencil, X, Save, AlertTriangle } from "lucide-react";
...
export default function AdminControls({ contributionId, fileUrl, currentTitle }: AdminControlsProps) {
    const { user } = useUser();
    ...
    const handleDelete = async () => {
        ...
        toast.promise(deleteFile(contributionId, fileKey), {
            loading: "Deleting...",
                ...
                {isOpen && (
                    <>
                        ...
                        <div
                            ...
                            onClick={() => { setIsOpen(false); setIsEditing(false); setIsDeleting(false); }}
                        />
                        ...
                        >
                            ...
                            {isDeleting ? (
                                ...
                                <div className="p-2 space-y-2">
                                    <label className="text-xs font-bold text-zinc-500">New Title</label>
                                    <input
                                        value={newTitle}
